...
export interface Message {
  ...
  // Recipient information (optional for backward compatibility)
  recipientType?: 'all_suppliers' | 'specific_suppliers' | 'buyer_team' | 'individual'
  recipientNames?: string[] // Names of specific recipients
  recipientCompanies?: string[] // Company names for suppliers
  content: string
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        ...
        recipientNames: ["Emma Davis"],
        recipientCompanies: ["GreenOffice Ltd"],
    ...
    messages: [
      {
        ...
        recipientCompanies: ["EcoSupply Co."],
