...
const ACTIVITY_TYPES = {
  ...
  rfp_approved: { label: 'Registration Approved', icon: CheckCircle, color: 'text-green-600 bg-green-100' },
  ...
  submission_released: { label: 'Submission Released', icon: CheckCircle, color: 'text-green-600 bg-green-100' },
  question_submitted: { label: 'Question Submitted', icon: MessageSquare, color: 'text-blue-600 bg-blue-100' },
  question_answered: { label: 'Question Answered', icon: MessageSquare, color: 'text-green-600 bg-green-100' },
  ...
  message_received: { label: 'Message Received', icon: MessageSquare, color: 'text-green-600 bg-green-100' },
  team_member_added: { label: 'Team Member Added', icon: UserPlus, color: 'text-green-600 bg-green-100' },
