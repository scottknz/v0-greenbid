...
export default function SupplierActivityPage() {
  ...
  const filteredActivities = useMemo(() => {
    return mockSupplierActivityLog.filter((activity) => {
      const matchesSearch =
  ...
  const handleExportCSV = () => {
    ...
    const rows = activitiesToExport.map((a) => [
      ...
      SUPPLIER_ACTIVITY_TYPES[a.type as SupplierActivityType]?.label || a.type,
      a.description,
      a.rfpTitle || '-',
    ])
      ...
      <div className="border border-border rounded-lg overflow-hidden bg-white">
        ...
        <div className="divide-y divide-border">
          {filteredActivities.map((activity) => {
            const config = SUPPLIER_ACTIVITY_TYPES[activity.type as SupplierActivityType]
